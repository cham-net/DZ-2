...
class ​ContactDetailsViewController: UITableViewController {
	...
	// Все аутлеты, так же как переменные, должны быть с маленькой буквы
	...
	// Если это только для тестов и логгов, то после проверки
	// лучше было бы удалить
...
//		Лучше тут задавать не просто строку, а брать
//		первый элемент из GroupsDataSource().groups
		group = "Одноклассники"
